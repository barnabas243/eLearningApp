...
urlpatterns = [
    ...
    path('upload-assignment/<int:course_id>/<int:week_number>/', views.upload_assignment_material, name='upload_assignment_material'),
    path('upload-student-submission/<int:assignment_id>/',views.upload_student_submission, name='upload_student_submission'),
